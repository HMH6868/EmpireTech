...
export default function CoursesPage() {
  ...
  const statusButtons: { id: "all" | "Published" | "Draft"; label: string }[] = [
    { id: "all", label: copy.filterAll[locale] },
    { id: "Published", label: copy.published[locale] },
    { id: "Draft", label: copy.draft[locale] },
  ]
      ...
      <main className="flex-1">
        <section className="border-b border-border/40 bg-muted/30 py-5 text-center">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-1 text-pretty text-base text-muted-foreground">{copy.subtitle[locale]}</p>
          </div>
        </section>
