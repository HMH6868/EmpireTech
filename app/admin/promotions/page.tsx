...
export default function AdminPromotionsPage() {
  ...
  const filteredPromotions = promotions.filter((promo) => {
    ...
    const description = getLocalizedString(promo.description, language).toLowerCase()
    const name = getLocalizedString(promo.name, language).toLowerCase()
                      ...
                      <TableCell>
                        <div className="flex flex-col">
                          ...
                          <span className="text-sm text-muted-foreground">
                            {getLocalizedString(promo.name, language)}
                          </span>
                        </div>
                      </TableCell>
                      <TableCell className="text-sm">{getLocalizedString(promo.description, language)}</TableCell>
                      <TableCell>
