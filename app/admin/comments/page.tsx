...
import { comments, type LocalizedText } from "@/lib/mock-data"
...
export default function AdminCommentsPage() {
  ...
  const filteredComments = comments.filter((comment) => {
    const commentText = getLocalizedString(comment.comment, language)
    const matchesSearch =
                      ...
                      <TableCell>
                        <Dialog>
                          <DialogTrigger asChild>
                            <button className="max-w-xs truncate text-left hover:underline">
                              {getLocalizedString(comment.comment, language)}
                            </button>
                          </DialogTrigger>
                          <DialogContent>
                            <DialogHeader>
