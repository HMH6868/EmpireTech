...
export const products: Product[] = [
  ...
  },
  {
    ...
    images: [
      "/images/products/canva-pro/main.png",
      "/images/products/canva-pro/templates.png",
    ],
    price: { usd: 32, vnd: 799000 },
    categoryId: "design-tools",
    rating: 4.8,
    inventoryStatus: "in-stock",
    deliveryType: localized("Delivered via secure workspace invite", "Gửi lời mời workspace bảo mật"),
    variants: [
      {
        id: "canva-pro-solo",
  ...
  },
  {
    ...
    images: [
      "/images/products/netflix/main.png",
      "/images/products/netflix/catalog.png",
    ],
    price: { usd: 12.99, vnd: 329000 },
    categoryId: "entertainment",
    rating: 4.7,
    inventoryStatus: "low-stock",
    deliveryType: localized("Shared slot with dedicated profile", "Chia sẻ tài khoản với hồ sơ riêng"),
    variants: [
      {
        id: "netflix-1m",
  ...
  },
  {
    ...
    images: [
      "/images/products/spotify/main.png",
    ],
  ...
  },
  {
    ...
    images: [
      "/images/products/figma/main.png",
    ],
  ...
  },
  {
    ...
    images: [
      "/images/products/m365/main.png",
    ],
    price: { usd: 28, vnd: 699000 },
    categoryId: "productivity",
    rating: 4.8,
    inventoryStatus: "in-stock",
    deliveryType: localized("Admin account with password reset", "Tài khoản quản trị kèm đổi mật khẩu"),
  },
]
...
export const courses: Course[] = [
  {
    ...
    images: [
      "/images/courses/web/main.png",
      "/images/courses/web/modules.png",
    ],
